          ...
          <div class="flex flex-row h-full">
            ...
            <div class="w-full sm:w-1/2 bg-white">
              <div class="flex items-center justify-center h-full px-5 sm:px-0">
                <form class="w-80" action="{{ route('login.action') }}" method="POST">
                  @csrf
                  <div class="text-left">
                  ...
                  <div class="mt-6 mb-4">
                    <button type="submit" class="w-full  text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Iniciar sesión</button>
                </div>
                  <div class="text-left">
                    <p class="text-xs mb-5 pb-2"><a class="text-gray-500">¿Olvidaste tu contraseña?</a></p>
                  </div>
                  <div class="text-left">
                    <p class="text-xs mb-5 pb-2"><a class="text-gray-500" href="{{ route('register')}}">Registrar</a></p>
                  </div>
                </form>
              </div>
            </div>
